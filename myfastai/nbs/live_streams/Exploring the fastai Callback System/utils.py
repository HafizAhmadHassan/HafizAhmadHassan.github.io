# This source code is directly from goralpl's Seq2Seq example, which we worked on debugging together https://github.com/goralpl/learning_fastai/blob/master/seq2seq_fastai_datablocks_custom_model.ipynb
